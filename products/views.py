...
def add_product(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Failed. Please make sure the form is filled in.')
    else:
        form = ProductForm()
...
def edit_product(request, product_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Failed product update. Please make sure to the form is filled in.')
    else:
